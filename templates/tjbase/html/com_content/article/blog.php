...
<div class="tjbase-banner">
    <div class="article-detailview-banner mod-banners">
        <div class="banner-items px-4">
            <div class="container">
    ...
    <div class="row">
        <div class="col-12 col-md-8 col-lg-9">
            <div class="com-content-article item-page <?php echo $this->pageclass_sfx; ?>" itemscope
                ...
                <div class="blog-detailView-Tags">
                    <h4 class="fw-bold article-detailview-tags">Tags</h4>
