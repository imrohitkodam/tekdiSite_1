...
<div class="container pb-5">
    ...
    <?php echo JHtml::_('content.prepare', '{loadposition industries-menu}'); ?>
    <?php echo JHtml::_('content.prepare', '{loadposition capabilities-menu}'); ?>

    <div class="com-content-article event-article item-page<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Article">
        ...
        <div class="industries-content">
            <div class="row">
                <div class="col-lg-4 col-12">
                    <div class="industries-left-sidebar">
                ...
                <div class="col-lg-8 col-12">
                    ...
                    <div class="similar-case-studies">
                        <?php echo JHtml::_('content.prepare', '{loadposition industries-case-studies}'); ?>
                    </div>
                </div>
            </div>    
