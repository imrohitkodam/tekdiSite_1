...
<div class="article-wrapper">
    <div class="success-stories article-cover text-white">
        <?php if ($params->get('item_title')): ?>
            <?php $item_heading = $params->get('item_heading', 'h3'); ?>
            <<?php echo $item_heading; ?> class="articles-sliders mt-2 mb-2">
        ...
        <?php if ($params->get('show_introtext', 1)): ?>
            ...
            if (strlen($introText) > 120) { ?>
                <div class="sliderArticles-content mt-2" style="height: 150px">
                    <?php
                    echo substr(strip_tags($introText), 0, 120) . '...'; ?>
                </div>
                <?php
            } else { ?>
                <div class="sliderArticles-content"  style="height: 150px;">
                    <?php
...
document.addEventListener("DOMContentLoaded", function () {
  const industryCards = document.querySelectorAll(".article-cover.success-stories");
