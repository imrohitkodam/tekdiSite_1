    ...
    <div class="row">
        ...
        <div class="col-md-7">
            <?php if ($params->get('item_title')): ?>
                ...
                <<?php echo $item_heading; ?> class="digitalArticles-sliders">
            ...
            <?php if ($params->get('show_introtext', 1)): ?>
                ...
                if (strlen($introText) > 140) { ?>
                    <div class="digitalArticles-content mb-0">
                        <p>
                            <?php
                    ...
                    <div class="digitalArticles-content">
                        <p>
                            <?php
                            echo $introText; ?>
                        </p>
