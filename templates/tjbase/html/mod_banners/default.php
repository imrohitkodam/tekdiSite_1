...
?>
    ...
    <?php foreach ($list as $item) : ?>
        ...
        <?php else : ?>
            ...
            <div class="mod-banners" style="background: linear-gradient(90deg, rgba(4, 28, 59, 1) 10%, rgba(4, 28, 59, 0.95) 20%, rgba(4, 28, 59, 0.70) 30%, rgba(12, 54, 109, 0) 70%), url('<?php echo $baseurl . $imageurl; ?>') center/cover no-repeat;">
                <!-- <div class="banner-overlay"></div> -->
