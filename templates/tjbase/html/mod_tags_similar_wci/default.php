...
?>
<?php if ($list) : ?>
	<div class="tagswci row similar-tags-article-list <?php echo $moduleclass_sfx; ?>">
	<?php foreach ($list as $i => $item) : ?>
		<div class="item col-12 col-lg-6 similar-tags-item">
			<div class="article-details">
				...
				<div class="info">
					...
					$text = strip_tags($item->core_body);
					?>
