...
<div class="hamburger-menu burger js-menuToggle">
	...
	<nav>
	<ul class="pushNav js-topPushNav"<?php
		$tag = '';
		...
		foreach ($list as $i => &$item) :
			...
			if ($item->deeper)
			{
				if ($item->level > 1){
					...
					$class .= ' deeper dropdown openLevel js-openLevel';
				}
			}
			...
			if ($item->deeper) {
				echo '<ul class="pushNav pushNav_level js-pushNavLevel">';
				echo '<li class="closeLevel js-closeLevel hdg"> Back </li>';
			}
...
jQuery('.js-openLevel').click( function(){
