...
?>
<div class="enrollHtml extended-enroll">
	<?php if ($userData->guest == 1) {
		...
		<div class="enroll-now control-group">
			<?php if($courseData['checkPrerequisiteCourseStatus'] == true) {?>
			<a href="<?php echo $tjlmshelperObj->tjlmsRoute('index.php?option=com_users&view=login&return=' . $url); ?>" class="btn btn-primary enable w-100 booking-btn">
			<?php echo Text::_('TJLMS_COURSE_ENROL')?>
			</a>
			<?php }else{?>
