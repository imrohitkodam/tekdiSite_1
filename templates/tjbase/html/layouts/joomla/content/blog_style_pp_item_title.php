			...
			<h2 itemprop="name">
				<?php if ($params->get('link_titles') && ($params->get('access-view') || $params->get('show_noauth', '0') == '1')) : ?>
					<a href="<?php echo Route::_(
						RouteHelper::getArticleRoute($displayData->slug, $displayData->catid, $displayData->language) . '&filter_tag[0]=2'
					); ?>" itemprop="url">
					<?php
					if (strlen($displayData->title) > 65) {
		       //echo substr($displayData->title, 0, 65) . '...';
