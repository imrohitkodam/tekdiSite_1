...
?>
<div class="category-name info_main joinus-Btn">
    ...
    <?php if ($displayData['params']->get('link_category') && !empty($displayData['item']->catid)) : ?>
        ...
        <?php echo Text::sprintf('COM_CONTENT_CATEGORY_IN', $url); ?>
    <?php else : ?>
        <?php echo Text::sprintf('COM_CONTENT_CATEGORY_IN', '<span itemprop="genre">' . $title . '</span>'); ?>
    <?php endif; ?>
</div>
