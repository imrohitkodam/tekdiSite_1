	...
	$.fn.juxtimeline = function(options){
		return this.each(function(){
			...
			function createTimeline(frame,title,description){
				...
				var html = '<div class="well well-small ntm-item"><button onclick="juxtimelineRemove(this);" class="btn btn-small" id="juxtimeline_remove" type="button"><i class="icon-remove" title="Remove"></i>Remove</button>'
